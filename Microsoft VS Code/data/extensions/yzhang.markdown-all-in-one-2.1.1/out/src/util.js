...
function getNewFeatureMsg(version) {
    switch (version) {
        ...
        case '2.1.0':
            return localize_1.default("2.1.0 msg");
    }
    return undefined;
}
exports.getNewFeatureMsg = getNewFeatureMsg;
function showChangelog() {
    vscode_1.commands.executeCommand('vscode.open', vscode_1.Uri.parse('https://github.com/yzhang-gh/vscode-markdown/blob/master/CHANGELOG.md'));
}
