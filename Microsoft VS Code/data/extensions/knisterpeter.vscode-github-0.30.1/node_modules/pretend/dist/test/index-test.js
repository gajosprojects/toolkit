...
var TestImpl = /** @class */ (function () {
    ...
    __decorate([
        src_1.Post('/path/withFormData', true),
        __param(0, src_1.FormData('name'))
    ], TestImpl.prototype, "postWithFormData", null);
    __decorate([
        src_1.Post('/path/withFormData', true),
        __param(1, src_1.FormData('name'))
    ...
    __decorate([
        src_1.Post('/path/withUrlEncodedBody', true),
    ...
    __decorate([
        src_1.Delete('/path/:id', false, true)
...
test('Pretend should call a get method without any parameter or query', function () {
    var test = setup();
...
test('Pretend should call a get method', function () {
    var test = setup();
...
test('Pretend should call a get method with query parameters', function () {
    var test = setup();
...
test('Pretend should call a get method and add a custom header', function () {
    var test = setup();
    nock('http://host:port/', {
        reqheaders: {
            accept: 'accept'
...
test('Pretend should throw on wrong custom header format', function () {
    /* tslint:disable */
...
test('Pretend should call a post method', function () {
    var test = setup();
...
test('Pretend should call a post method with query and body', function () {
    var test = setup();
...
test('Pretend should call a post method with FormData', function () {
    var test = setup();
    nock('http://host:port/', {
        reqheaders: {
...
test('Pretend should call a post method with FormData and query', function () {
    var test = setup();
    nock('http://host:port/', {
        reqheaders: {
            'Content-Type': /^multipart\/form-data/
...
test('Pretend should call a post method with empty FormData and query', function () {
    var test = setup();
    nock('http://host:port/', {
        reqheaders: {
            'Content-Type': /^multipart\/form-data/
...
test('Pretend should call a post method and form-encode the body', function () {
    var test = setup();
    nock('http://host:port/')
...
test('Pretend should call a put method', function () {
...
test('Pretend should call a put method with query parameters', function () {
    var test = setup();
...
test('Pretend should call a delete method', function () {
    var test = setup();
...
test('Pretend should throw on error', function () {
    var test = setup();
...
test('Pretend should call a delete method and send a body', function () {
    var test = setup();
...
test('Pretend should call a delete method and append query parameters', function () {
    var test = setup();
...
test('Pretend should call a patch method and send a body', function () {
    var test = setup();
...
test('Pretend should return content based on decoder configuration', function () {
    /* tslint:disable */
    var Api = /** @class */ (function () {
        function Api() {
        }
...
test('Pretend should use basic auth if configured', function () {
    /* tslint:disable */
    var Api = /** @class */ (function () {
        function Api() {
        }
...
test('Pretend should return from the interceptor', function () {
    nock('http://host:port/')
...
test('Pretend should reset per-request data after each request', function () {
    var test = setup();
...
test('Pretend should reset per-request data after error requests', function () {
    var test = setup();
