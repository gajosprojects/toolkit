...
class HtmlPreviewDocumentContentProvider {
    ...
    showRazorHtmlWindow() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield vscode.commands.executeCommand('vscode.previewHtml', HtmlPreviewDocumentContentProvider.previewUri, vscode.ViewColumn.Two, 'Razor HTML Output');
            }
            catch (error) {
...
HtmlPreviewDocumentContentProvider.scheme = `${HtmlProjectedDocumentContentProvider_1.HtmlProjectedDocumentContentProvider.scheme}-preview`;
HtmlPreviewDocumentContentProvider.previewUri = vscode.Uri.parse(`${HtmlPreviewDocumentContentProvider.scheme}://razor/htmlpreview`);
exports.HtmlPreviewDocumentContentProvider = HtmlPreviewDocumentContentProvider;
//# sourceMappingURL=HtmlPreviewDocumentContentProvider.js.map