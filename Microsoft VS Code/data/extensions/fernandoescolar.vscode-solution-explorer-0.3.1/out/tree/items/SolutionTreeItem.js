...
class SolutionTreeItem extends TreeItem_1.TreeItem {
    ...
    refreshContextValue() {
        if (this.containsContextValueChildren(ContextValues_1.ContextValues.Project + '-cps')) {
            this.contextValue = ContextValues_1.ContextValues.Solution + '-cps';
        }
        else {
            this.contextValue = ContextValues_1.ContextValues.Solution;
        }
    }
    dispose() {
