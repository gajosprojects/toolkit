...
class ProjectFolderTreeItem extends _1.TreeItem {
    constructor(context, projectFolder) {
        super(context, projectFolder.name, _1.TreeItemCollapsibleState.Collapsed, ContextValues_1.ContextValues.ProjectFolder, projectFolder.fullPath);
