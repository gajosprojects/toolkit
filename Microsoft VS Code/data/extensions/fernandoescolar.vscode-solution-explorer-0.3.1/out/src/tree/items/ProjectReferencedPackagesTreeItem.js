...
class ProjectReferencedPackagesTreeItem extends _1.TreeItem {
    constructor(context) {
        super(context, "packages", _1.TreeItemCollapsibleState.Collapsed, ContextValues_1.ContextValues.ProjectReferencedPackages);
